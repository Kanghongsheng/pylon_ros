...
int main(int argc, char* argv[]){
    ros::init(argc, argv, "pylon_node_3" );
    ros::NodeHandle pylon;
    ros::Publisher image_pub = pylon.advertise<sensor_msgs::Image>("/pylon/raw_image_3", 10);
    ...
    cv::namedWindow("pylon_image_3",0);
	...
	//Pylon::CInstantCamera camera(Pylon::CTlFactory::GetInstance().CreateFirstDevice());
        ...
        while (camera.IsGrabbing()) {
            ...
            header.frame_id = "Pylon_camera_3";
		...
		cv::resize(Image, mini_Image, cv::Size(960, 600));
                ...
                cv::imshow("pylon_image_3", mini_Image);
